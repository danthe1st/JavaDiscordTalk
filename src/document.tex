...
% Inline-Codeblocks-->\texttt{Text}
%\pause oder \item<3-> oder \uncover<3->{alles, was zu uncovern ist}}
% You can create overlays
...
% mention of 'inline' modifier: https://download.java.net/java/early_access/valhalla/docs/api/java.base/java/lang/__inline__.html
\begin{lstlisting}
